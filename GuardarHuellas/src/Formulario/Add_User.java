...
public class Add_User extends javax.swing.JFrame {
    ...
    public void abrir (){
        ...
        try {
            ...
            File ruta = new File(".//CapturahuellaDigital.jar");
            Desktop.getDesktop().open(ruta);
            System.exit(0);

        } catch (IOException ex) {
                jTextAreaGuardar.append("error" + ex);
            System.out.println(ex);
        }
    }
    
    public void Limpiar (){
        jTextAreaGuardar.setText("");
        jTxCargo.setText("");
        jTxCorreo.setText("");
        jTxNombre.setText("");  
        jTxTelefono.setText("");
    ...
    private void initComponents() {
        ...
        jPCerrar.add(jlbCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 30, 40));
